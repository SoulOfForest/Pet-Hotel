 ...
 * @author ViruSs0209
 */
public class PetsView extends HttpServlet {
    @Inject
    private IPetService db;
    
    @Inject
    private IBookingService bookingDB;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("currentBooking", bookingDB.getBookingByPetId(id));
        request.setAttribute("pet", db.getByID(id));
        request.setAttribute("currentMenu", "pets");
        request.getRequestDispatcher("/view/pet/petView.jsp").forward(request, response);
    }
