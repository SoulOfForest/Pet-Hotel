...
//    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean isLoggedIn = ((session != null || userName != null) && session.getAttribute("user") != null);      
        ...
        if (isLoggedIn && (isLoginRequest || isLoginPage)) {
            ...
            if (currentUser != null && currentUser.getRole().equals("pet owner")) {
            ...
            session.setAttribute("setting", settingDB.getSettings()); 
